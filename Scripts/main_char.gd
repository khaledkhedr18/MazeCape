...
func _physics_process(delta):
	...
	var direction = Vector3(Input.get_action_strength("ui_left") - Input.get_action_strength("ui_right"),
	 0, Input.get_action_strength("ui_up") - Input.get_action_strength("ui_down"))
	...
	velocity = ((currentRotation.normalized() * $AnimationTree.get_root_motion_position()) * SPEED) / delta
